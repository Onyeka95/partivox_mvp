        ...
        {campaigns.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link href="/dashboard/campaigns">
              <button className="bg-[#caf403] text-black px-6 py-3 rounded-full font-semibold hover:bg-[#b0e000] transition">
            ...
            {campaigns.map((campaign) => (
              ...
              >
                ...
                <CardContent>
                  ...
                  {/* Removed the Reward line completely for MVP */}
                </CardContent>
                <CardFooter className="flex justify-between">
                  {/* View Details links to the public engagement page */}
                  <Link href={`/dashboard/claim/${campaign.id}`}>
                  ...
                  {campaign.status === "approved" && (
                    <Badge variant="outline" className="bg-green-950 text-green-400 border-green-600">
                      Live on Task Feed
                    </Badge>
                  )}
                </CardFooter>
